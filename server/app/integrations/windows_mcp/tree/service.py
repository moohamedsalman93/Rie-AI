from app.integrations.windows_mcp.tree.config import INTERACTIVE_CONTROL_TYPE_NAMES,DOCUMENT_CONTROL_TYPE_NAMES,INFORMATIVE_CONTROL_TYPE_NAMES, DEFAULT_ACTIONS, THREAD_MAX_RETRIES
from app.integrations.windows_mcp.tree.views import TreeElementNode, ScrollElementNode, TextElementNode, Center, BoundingBox, TreeState, DOMInfo
from uiautomation import Control,ImageControl,ScrollPattern,WindowControl,Rect,GetRootControl,PatternId
from concurrent.futures import ThreadPoolExecutor, as_completed
from app.integrations.windows_mcp.tree.utils import random_point_within_bounding_box
from PIL import Image, ImageFont, ImageDraw
from typing import TYPE_CHECKING,Optional
# from app.integrations.windows_mcp.desktop.views import App # Avoid circular import if possible, or use TYPE_CHECKING
...
if TYPE_CHECKING:
    ...
    from app.integrations.windows_mcp.desktop.views import App
...
class Tree:
                ...
                for future in as_completed(list(future_to_app)):
                    ...
                    try:
                        ...
                        if retry_counts[app] < THREAD_MAX_RETRIES:
                            ...
                            new_future = executor.submit(self._get_nodes_with_com, app, self.desktop.is_app_browser(app),use_dom)
    ...
    def _get_nodes_with_com(self, node: Control, is_browser:bool=False,use_dom:bool=False):
        pythoncom.CoInitialize()
        try:
            return self.get_nodes(node, is_browser, use_dom)
        finally:
            pythoncom.CoUninitialize()

    def get_nodes(self, node: Control, is_browser:bool=False,use_dom:bool=False) -> tuple[list[TreeElementNode],list[ScrollElementNode],list[TextElementNode]]:
